...
class PageDonateFood extends StatefulWidget {
  @override
  _PageDonateFoodState createState() => _PageDonateFoodState();
}

class _PageDonateFoodState extends State<PageDonateFood> {
  final List<Map> donateUrlsJsonList = donate_food_page_urls;
